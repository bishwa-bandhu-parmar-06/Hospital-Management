      ...
      <section className="py-16 bg-[var(--color-accentlight)]">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <button onClick={() => navigate("/contact")} className="border-2 border-[var(--color-primary)] text-[var(--color-primary)] hover:bg-white font-semibold py-3 px-8 rounded-lg transition-colors duration-300">
              Contact Us
            </button>
          </div>
        </div>
